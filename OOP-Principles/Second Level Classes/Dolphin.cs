...
{
    public class Dolphin : Fish, ICanSwim
    {
        ...
        public Dolphin(int swimSpeed, string name, int age, string gender, int weight)
        {
        ...
        public override void EasyToSpot()
        {
            if (this.Name == "Adam")
            {
                Console.WriteLine($"{this.Name} has a camaflouged skin, he's hard to spot");
            }
            else
            {
                base.EasyToSpot();
